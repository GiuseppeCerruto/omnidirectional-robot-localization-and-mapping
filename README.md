...
Outside the main package, under [/previously_generated_maps/](previously_generated_maps/), you can find the maps and trajectories generated by us.

Moreover, [/src/ira_laser_tools](src/ira_laser_tools/) is a third-party package that we included in the launch files to merge the two laser scans of the robot. 
